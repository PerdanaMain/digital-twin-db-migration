...
class PFIWOStaging(db.Model, BaseModel, TimestampMixin, metaclass=MetaBaseModel):
    ...
    wo_start = db.Column(db.Text, nullable=True)
    wo_finish = db.Column(db.Text, nullable=True)
    wo_start_olah = db.Column(db.Text, nullable=True)
    wo_finish_olah = db.Column(db.Text, nullable=True)
    reportdate = db.Column(db.Text, nullable=True)
    reportdate_olah = db.Column(db.Text, nullable=True)
    time_to_event = db.Column(db.Text, nullable=True)
    actstart = db.Column(db.Text, nullable=True)
    actfinish = db.Column(db.Text, nullable=True)
    actstart_olah = db.Column(db.Text, nullable=True)
    actfinish_olah = db.Column(db.Text, nullable=True)
